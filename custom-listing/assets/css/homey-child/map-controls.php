...
<div class="map-next-prev-actions">
    ...
    <?php } ?>
    <button id="homey-gmap-prev" class="map-btn"><span><i class="fa fa-arrow-left" aria-hidden="true"></i><?php //mb_strtolower(esc_html_e('Prev', 'homey')); ?></span></button>
    <button id="homey-gmap-next" class="map-btn"><span><i class="fa fa-arrow-right" aria-hidden="true"></i><?php //mb_strtolower(esc_html_e('Next', 'homey')); ?></span></button>
</div>
<?php if( homey_get_map_system() == 'google') { ?>
